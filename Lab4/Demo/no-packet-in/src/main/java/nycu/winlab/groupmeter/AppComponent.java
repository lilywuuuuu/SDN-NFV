...
public class AppComponent {
    ...
    private ConnectPoint h1, h2, h3;
    private MacAddress mac1, mac2, mac3;
    private Ip4Address ip1, ip2, ip3;
        ...
        public void event(NetworkConfigEvent event) {
            if ((event.type() == CONFIG_ADDED || event.type() == CONFIG_UPDATED)
                ...
                if (config != null) {
                    ...
                    h3 = ConnectPoint.deviceConnectPoint(config.host3());
                    mac1 = MacAddress.valueOf(config.mac1());
                    mac2 = MacAddress.valueOf(config.mac2());
                    mac3 = MacAddress.valueOf(config.mac3());
                    ip1 = Ip4Address.valueOf(config.ip1());
                    ip2 = Ip4Address.valueOf(config.ip2());
                    ip3 = Ip4Address.valueOf(config.ip3());

                    // log information
                    log.info("ConnectPoint_h1: {}, ConnectPoint_h2: {}, ConnectPoint_h3: {}", h1, h2, h3);
